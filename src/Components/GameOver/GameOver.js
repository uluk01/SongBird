            ...
            <div className={'jumbotron game-over'}>
                { score < 30 &&
                    <div>
                        ...
                        <hr className={'my-4'}/>
                        <button className={'btn btn-primary btn-game-over'} onClick={restartGame}>Попробовать еще раз!</button>
                    </div>
                }
                {score >=30 &&
                    <div>
                        ...
                        <h4 className={'text-center'}>Вам присуждается звание: "Птичий мастер"</h4>
                        <button onClick={endGame} className={'btn btn-primary'}> Выйти из игры</button>
