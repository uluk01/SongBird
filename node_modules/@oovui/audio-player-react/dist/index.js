...
var OAudioPlayer = function (_Component) {
  ...
  function OAudioPlayer(props) {
    ...
    _this.audioPlayerRef = React__default.createRef();
    _this.progressBarDetailRef = React__default.createRef();
    return _this;
  }
    ...
    */
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement('audio', { className: 'wx-audio-content',
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'div',
            { className: 'body-left' },
            React__default.createElement('img', { onClick: this.audioPlayPause, className: 'wx-audio-state', src: playSrc })
          ),
          React__default.createElement(
            'div',
            ...
            React__default.createElement(
              ...
              React__default.createElement(
                ...
                React__default.createElement('div', { className: 'progress-bar-buffer', style: { width: bufferedPercent + '%' } }),
                React__default.createElement('div', { className: 'progress-bar-current', style: { width: 'calc((' + currentTimeNum + '/' + durationNum + ')*100%)' } }),
                React__default.createElement(
                  'span',
                  { className: 'progress-bar-loading' },
                  React__default.createElement('span', { className: 'loading-line' })
                )
              ),
              React__default.createElement('div', { className: 'progress-bar-drag-point', style: { left: 'calc((' + currentTimeNum + '/' + durationNum + ')*100%)' } })
            ),
            React__default.createElement(
              'div',
        ...
        React__default.createElement('div', { className: 'player-list' })
      );
    }
  }]);
  return OAudioPlayer;
